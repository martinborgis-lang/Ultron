...
export const SHEET_STAGES: UnifiedStage[] = [
  ...
  { id: 'sheet-4', slug: 'negociation', name: 'Négociation', color: '#8b5cf6', position: 3, is_won: false, is_lost: false, sheet_status: 'Négociation' },
  { id: 'sheet-5', slug: 'gagne', name: 'Gagné', color: '#22c55e', position: 4, is_won: true, is_lost: false, sheet_status: 'Gagné' },
  { id: 'sheet-6', slug: 'perdu', name: 'Perdu', color: '#ef4444', position: 5, is_won: false, is_lost: true, sheet_status: 'Refus' },
];
